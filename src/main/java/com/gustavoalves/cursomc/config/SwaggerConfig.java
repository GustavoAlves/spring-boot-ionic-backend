...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				// Desabilitando as respostas padrão e determinando as respostas definidas para os métodos básicos
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.gustavoalves.cursomc.resources"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("API do curso Spring Boot",
				...
				new Contact("Gustavo Alves", "linkedin.com/in/gusalves/", "gustavo_alves@outlook.com"),
